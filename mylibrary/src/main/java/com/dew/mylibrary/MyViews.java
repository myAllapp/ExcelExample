...
public class MyViews extends View {
    ...
    public MyViews(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int arcColor = ContextCompat.getColor(context, R.color.colorPrimary);
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.MyViewsPoints, 0, 0);

            Drawable indicatorIcon = a.getDrawable(R.styleable.MyViewsPoints_indicatorIcon);
            ...
            mPoints = a.getInteger(R.styleable.MyViewsPoints_points, mPoints);
            mMin = a.getInteger(R.styleable.MyViewsPoints_min, mMin);
            mMax = a.getInteger(R.styleable.MyViewsPoints_max, mMax);
            mStep = a.getInteger(R.styleable.MyViewsPoints_step, mStep);


            mProgressWidth = (int) a.getDimension(R.styleable.MyViewsPoints_progressWidth, mProgressWidth);
            progressColor = a.getColor(R.styleable.MyViewsPoints_progressColor, progressColor);


            mArcWidth = (int) a.getDimension(R.styleable.MyViewsPoints_arcWidth, mArcWidth);
            arcColor = a.getColor(R.styleable.MyViewsPoints_arcColor, arcColor);

            mTextSize = (int) a.getDimension(R.styleable.MyViewsPoints_textSize, mTextSize);
            textColor = a.getColor(R.styleable.MyViewsPoints_textColor, textColor);

            mClockwise = a.getBoolean(R.styleable.MyViewsPoints_clockwise,
                    mClockwise);
            mEnabled = a.getBoolean(R.styleable.MyViewsPoints_enabled, mEnabled);
...
//				System.out.printf("-- %d, %d, %f\n", progress, mPoints, mProgressSweep);
    ...
    public interface OnSwagPointsChangeListener {
         ...
         */
        void onPointsChanged(MyViews swagPoints, int points, boolean fromUser);

        void onStartTrackingTouch(MyViews swagPoints);

        void onStopTrackingTouch(MyViews swagPoints);
    }
